...
***************************************/
...
#if (I2CS_RX_WAKE_SCL_MOSI_PIN)
    #define I2CS_RX_WAKE_SCL_MOSI_HSIOM_REG \
                            (*(reg32 *) I2CS_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define I2CS_RX_WAKE_SCL_MOSI_HSIOM_PTR \
                            ( (reg32 *) I2CS_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define I2CS_RX_WAKE_SCL_MOSI_HSIOM_MASK \
                            (I2CS_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define I2CS_RX_WAKE_SCL_MOSI_HSIOM_POS \
                            (I2CS_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)

    #define I2CS_RX_WAKE_SCL_MOSI_INTCFG_REG \
                            (*(reg32 *) I2CS_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define I2CS_RX_WAKE_SCL_MOSI_INTCFG_PTR \
                            ( (reg32 *) I2CS_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define I2CS_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (I2CS_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define I2CS_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK \
    ...
    #define I2CS_TX_HSIOM_PTR   ( (reg32 *) I2CS_tx_0__HSIOM)

...
#if !(CY_PSOC5A &&\
	 Mux_5__PORT == 15 && ((Mux_5__MASK & 0xC0) != 0))
...
void    Mux_5_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Mux_5_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Mux_5__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Mux_5_SetInterruptMode() function.
     *  @{
     */
        #define Mux_5_INTR_NONE      (uint16)(0x0000u)
        #define Mux_5_INTR_RISING    (uint16)(0x0001u)
        #define Mux_5_INTR_FALLING   (uint16)(0x0002u)
        #define Mux_5_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Mux_5_INTR_MASK      (0x01u) 
#endif /* (Mux_5__INTSTAT) */
...
/* SIO registers */
#if defined(Mux_5__SIO_CFG)
    #define Mux_5_SIO_HYST_EN        (* (reg8 *) Mux_5__SIO_HYST_EN)
    #define Mux_5_SIO_REG_HIFREQ     (* (reg8 *) Mux_5__SIO_REG_HIFREQ)
    #define Mux_5_SIO_CFG            (* (reg8 *) Mux_5__SIO_CFG)
    #define Mux_5_SIO_DIFF           (* (reg8 *) Mux_5__SIO_DIFF)
#endif /* (Mux_5__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Mux_5_0_INTTYPE_REG 		(* (reg8 *) Mux_5__0__INTTYPE)
#endif /* (Mux_5__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Mux_5_H */

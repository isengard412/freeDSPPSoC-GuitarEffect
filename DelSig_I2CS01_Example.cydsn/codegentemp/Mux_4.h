...
#if !(CY_PSOC5A &&\
	 Mux_4__PORT == 15 && ((Mux_4__MASK & 0xC0) != 0))
...
void    Mux_4_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Mux_4_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Mux_4__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Mux_4_SetInterruptMode() function.
     *  @{
     */
        #define Mux_4_INTR_NONE      (uint16)(0x0000u)
        #define Mux_4_INTR_RISING    (uint16)(0x0001u)
        #define Mux_4_INTR_FALLING   (uint16)(0x0002u)
        #define Mux_4_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Mux_4_INTR_MASK      (0x01u) 
#endif /* (Mux_4__INTSTAT) */
...
/* SIO registers */
#if defined(Mux_4__SIO_CFG)
    #define Mux_4_SIO_HYST_EN        (* (reg8 *) Mux_4__SIO_HYST_EN)
    #define Mux_4_SIO_REG_HIFREQ     (* (reg8 *) Mux_4__SIO_REG_HIFREQ)
    #define Mux_4_SIO_CFG            (* (reg8 *) Mux_4__SIO_CFG)
    #define Mux_4_SIO_DIFF           (* (reg8 *) Mux_4__SIO_DIFF)
#endif /* (Mux_4__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Mux_4_0_INTTYPE_REG 		(* (reg8 *) Mux_4__0__INTTYPE)
#endif /* (Mux_4__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Mux_4_H */

...
*
* \funcusage
*  \snippet Mux_3_SUT.c usage_Mux_3_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Mux_3_SUT.c usage_Mux_3_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Mux_3_SUT.c usage_Mux_3_Read  
*******************************************************************************/
...
* preferred Mux_3_Read() API because the 
* Mux_3_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Mux_3_SUT.c usage_Mux_3_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Mux_3_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Mux_3_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Mux_3_0_INTR       (First pin in the list)
    *  - Mux_3_1_INTR       (Second pin in the list)
    *  - ...
    *  - Mux_3_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Mux_3_SUT.c usage_Mux_3_SetInterruptMode
    *******************************************************************************/
    void Mux_3_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Mux_3_0_INTR) != 0u) 
		{ 
			 Mux_3_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Mux_3_SUT.c usage_Mux_3_ClearInterrupt
    *******************************************************************************/

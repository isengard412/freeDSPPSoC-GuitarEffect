// ======================================================================
// SAR_SPIM_USB_Test01.v generated from TopDesign.cysch
// 05/13/2016 at 10:41
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("20799812-05db-4821-88d0-89fef43e651d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Dev_mosi_net;
	wire [0:0] tmpFB_0__Dev_mosi_net;
	wire [0:0] tmpIO_0__Dev_mosi_net;
	wire [0:0] tmpINTERRUPT_0__Dev_mosi_net;
	electrical [0:0] tmpSIOVREF__Dev_mosi_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Dev_mosi
		 (.oe(tmpOE__Dev_mosi_net),
		  .y({Net_16}),
		  .fb({tmpFB_0__Dev_mosi_net[0:0]}),
		  .io({tmpIO_0__Dev_mosi_net[0:0]}),
		  .siovref(tmpSIOVREF__Dev_mosi_net),
		  .interrupt({tmpINTERRUPT_0__Dev_mosi_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dev_mosi_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dev_sclk_net;
	wire [0:0] tmpFB_0__Dev_sclk_net;
	wire [0:0] tmpIO_0__Dev_sclk_net;
	wire [0:0] tmpINTERRUPT_0__Dev_sclk_net;
	electrical [0:0] tmpSIOVREF__Dev_sclk_net;

	cy_psoc3_pins_v1_10
		#(.id("683f63bb-bb76-412e-9cf5-12f6225f2f59"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dev_sclk
		 (.oe(tmpOE__Dev_sclk_net),
		  .y({Net_17}),
		  .fb({tmpFB_0__Dev_sclk_net[0:0]}),
		  .io({tmpIO_0__Dev_sclk_net[0:0]}),
		  .siovref(tmpSIOVREF__Dev_sclk_net),
		  .interrupt({tmpINTERRUPT_0__Dev_sclk_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dev_sclk_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dev_ss_net;
	wire [0:0] tmpFB_0__Dev_ss_net;
	wire [0:0] tmpIO_0__Dev_ss_net;
	wire [0:0] tmpINTERRUPT_0__Dev_ss_net;
	electrical [0:0] tmpSIOVREF__Dev_ss_net;

	cy_psoc3_pins_v1_10
		#(.id("8f725bc8-28fb-4f08-a479-700f0d944308"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dev_ss
		 (.oe(tmpOE__Dev_ss_net),
		  .y({Net_13}),
		  .fb({tmpFB_0__Dev_ss_net[0:0]}),
		  .io({tmpIO_0__Dev_ss_net[0:0]}),
		  .siovref(tmpSIOVREF__Dev_ss_net),
		  .interrupt({tmpINTERRUPT_0__Dev_ss_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dev_ss_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dev_miso_net;
	wire [0:0] tmpFB_0__Dev_miso_net;
	wire [0:0] tmpIO_0__Dev_miso_net;
	wire [0:0] tmpINTERRUPT_0__Dev_miso_net;
	electrical [0:0] tmpSIOVREF__Dev_miso_net;

	cy_psoc3_pins_v1_10
		#(.id("efe99462-1f33-4433-a902-f3c62a2d200e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dev_miso
		 (.oe(tmpOE__Dev_miso_net),
		  .y({Net_20}),
		  .fb({tmpFB_0__Dev_miso_net[0:0]}),
		  .io({tmpIO_0__Dev_miso_net[0:0]}),
		  .siovref(tmpSIOVREF__Dev_miso_net),
		  .interrupt({tmpINTERRUPT_0__Dev_miso_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dev_miso_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dev_GND_net;
	wire [0:0] tmpFB_0__Dev_GND_net;
	wire [0:0] tmpIO_0__Dev_GND_net;
	wire [0:0] tmpINTERRUPT_0__Dev_GND_net;
	electrical [0:0] tmpSIOVREF__Dev_GND_net;

	cy_psoc3_pins_v1_10
		#(.id("0c3aea01-e986-4246-8106-31ac142ec8dd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dev_GND
		 (.oe(tmpOE__Dev_GND_net),
		  .y({Net_42}),
		  .fb({tmpFB_0__Dev_GND_net[0:0]}),
		  .io({tmpIO_0__Dev_GND_net[0:0]}),
		  .siovref(tmpSIOVREF__Dev_GND_net),
		  .interrupt({tmpINTERRUPT_0__Dev_GND_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dev_GND_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

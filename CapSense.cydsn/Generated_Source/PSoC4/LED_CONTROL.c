...
void LED_CONTROL_Enable(void)
{
    ...
    #if (LED_CONTROL__QUAD == LED_CONTROL_CONFIG)
        #if (0u != LED_CONTROL_QUAD_AUTO_START)
            LED_CONTROL_TriggerCommand(LED_CONTROL_MASK, LED_CONTROL_CMD_RELOAD);
        #endif /* (0u != LED_CONTROL_QUAD_AUTO_START) */
    #endif  /* (LED_CONTROL__QUAD == LED_CONTROL_CONFIG) */
}
...
*   Values:
*     - LED_CONTROL_CMD_CAPTURE    - Trigger Capture/Switch command
*     - LED_CONTROL_CMD_RELOAD     - Trigger Reload/Index command
*     - LED_CONTROL_CMD_STOP       - Trigger Stop/Kill command
*     - LED_CONTROL_CMD_START      - Trigger Start/phiB command
*
* Return:
*  None
*

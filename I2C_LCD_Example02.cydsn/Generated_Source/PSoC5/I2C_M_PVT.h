...
#if !defined(CY_I2C_PVT_I2C_M_H)
#define CY_I2C_PVT_I2C_M_H

#include "I2C_M.h"

#define I2C_M_TIMEOUT_ENABLED_INC    (0u)
#if (0u != I2C_M_TIMEOUT_ENABLED_INC)
    #include "I2C_M_TMOUT.h"
#endif /* (0u != I2C_M_TIMEOUT_ENABLED_INC) */
...
/* Slave variables */
    ...
    extern volatile uint8 I2C_M_wakeupSource;
#endif /* ((I2C_M_FF_IMPLEMENTED) && (I2C_M_WAKEUP_ENABLED)) */


#endif /* CY_I2C_PVT_I2C_M_H */

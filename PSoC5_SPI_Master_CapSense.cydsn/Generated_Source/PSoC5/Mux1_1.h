...
void    Mux1_1_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Mux1_1_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Mux1_1__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Mux1_1_SetInterruptMode() function.
     *  @{
     */
        #define Mux1_1_INTR_NONE      (uint16)(0x0000u)
        #define Mux1_1_INTR_RISING    (uint16)(0x0001u)
        #define Mux1_1_INTR_FALLING   (uint16)(0x0002u)
        #define Mux1_1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Mux1_1_INTR_MASK      (0x01u) 
#endif /* (Mux1_1__INTSTAT) */
...
/* SIO registers */
#if defined(Mux1_1__SIO_CFG)
    #define Mux1_1_SIO_HYST_EN        (* (reg8 *) Mux1_1__SIO_HYST_EN)
    #define Mux1_1_SIO_REG_HIFREQ     (* (reg8 *) Mux1_1__SIO_REG_HIFREQ)
    #define Mux1_1_SIO_CFG            (* (reg8 *) Mux1_1__SIO_CFG)
    #define Mux1_1_SIO_DIFF           (* (reg8 *) Mux1_1__SIO_DIFF)
#endif /* (Mux1_1__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Mux1_1_0_INTTYPE_REG 		(* (reg8 *) Mux1_1__0__INTTYPE)
#endif /* (Mux1_1__INTSTAT) */

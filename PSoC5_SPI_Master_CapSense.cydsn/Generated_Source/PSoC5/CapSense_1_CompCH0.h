...
extern uint8 CapSense_1_CompCH0_initVar;
...
*             Registers        
**************************************/
#define CapSense_1_CompCH0_CR_REG            (* (reg8 *) CapSense_1_CompCH0_ctComp__CR )               /* Config register */
#define CapSense_1_CompCH0_CR_PTR            (  (reg8 *) CapSense_1_CompCH0_ctComp__CR )
#define CapSense_1_CompCH0_CLK_REG           (* (reg8 *) CapSense_1_CompCH0_ctComp__CLK )  /* Comp clock control register */
#define CapSense_1_CompCH0_CLK_PTR           (  (reg8 *) CapSense_1_CompCH0_ctComp__CLK )
#define CapSense_1_CompCH0_SW0_REG           (* (reg8 *) CapSense_1_CompCH0_ctComp__SW0 )            /* Routing registers */
#define CapSense_1_CompCH0_SW0_PTR           (  (reg8 *) CapSense_1_CompCH0_ctComp__SW0 )
#define CapSense_1_CompCH0_SW2_REG           (* (reg8 *) CapSense_1_CompCH0_ctComp__SW2 )
#define CapSense_1_CompCH0_SW2_PTR           (  (reg8 *) CapSense_1_CompCH0_ctComp__SW2 )
#define CapSense_1_CompCH0_SW3_REG           (* (reg8 *) CapSense_1_CompCH0_ctComp__SW3 )
#define CapSense_1_CompCH0_SW3_PTR           (  (reg8 *) CapSense_1_CompCH0_ctComp__SW3 )
#define CapSense_1_CompCH0_SW4_REG           (* (reg8 *) CapSense_1_CompCH0_ctComp__SW4 )
#define CapSense_1_CompCH0_SW4_PTR           (  (reg8 *) CapSense_1_CompCH0_ctComp__SW4 )
#define CapSense_1_CompCH0_SW6_REG           (* (reg8 *) CapSense_1_CompCH0_ctComp__SW6 )
#define CapSense_1_CompCH0_SW6_PTR           (  (reg8 *) CapSense_1_CompCH0_ctComp__SW6 )

/* Trim registers */
/* PSoC5A */
#if (CY_PSOC5A)
    #define CapSense_1_CompCH0_TR_REG        (* (reg8 *) CapSense_1_CompCH0_ctComp__TR )                /* Trim registers */
    #define CapSense_1_CompCH0_TR_PTR        (  (reg8 *) CapSense_1_CompCH0_ctComp__TR )
#endif /* CY_PSOC5A */

/* PSoC3, PSoC5LP or later */
#if (CY_PSOC3 || CY_PSOC5LP) 
    #define CapSense_1_CompCH0_TR0_REG       (* (reg8 *) CapSense_1_CompCH0_ctComp__TR0 )/* Trim register for P-type load */
    #define CapSense_1_CompCH0_TR0_PTR       (  (reg8 *) CapSense_1_CompCH0_ctComp__TR0 ) 
    #define CapSense_1_CompCH0_TR1_REG       (* (reg8 *) CapSense_1_CompCH0_ctComp__TR1 )/* Trim register for N-type load */
    #define CapSense_1_CompCH0_TR1_PTR       (  (reg8 *) CapSense_1_CompCH0_ctComp__TR1 ) 
#endif /* CY_PSOC3 || CY_PSOC5LP */

#define CapSense_1_CompCH0_WRK_REG           (* (reg8 *) CapSense_1_CompCH0_ctComp__WRK )    /* Working register - output */
#define CapSense_1_CompCH0_WRK_PTR           (  (reg8 *) CapSense_1_CompCH0_ctComp__WRK )
#define CapSense_1_CompCH0_PWRMGR_REG        (* (reg8 *) CapSense_1_CompCH0_ctComp__PM_ACT_CFG )  /* Active Power manager */
#define CapSense_1_CompCH0_PWRMGR_PTR        (  (reg8 *) CapSense_1_CompCH0_ctComp__PM_ACT_CFG )
#define CapSense_1_CompCH0_STBY_PWRMGR_REG   (* (reg8 *) CapSense_1_CompCH0_ctComp__PM_STBY_CFG )/* Standby Power manager */
#define CapSense_1_CompCH0_STBY_PWRMGR_PTR   (  (reg8 *) CapSense_1_CompCH0_ctComp__PM_STBY_CFG )

/*      Trim Locations      */
#define CapSense_1_CompCH0_ctComp__TRIM__TR0_HS_PTR     ((void CYFAR *) CapSense_1_CompCH0_ctComp__TRIM__TR0_HS)
#define CapSense_1_CompCH0_ctComp__TRIM__TR0_HS_REG     CY_GET_XTND_REG8(CapSense_1_CompCH0_ctComp__TRIM__TR0_HS_PTR)
#if (CY_PSOC3 || CY_PSOC5LP)
    #define CapSense_1_CompCH0_ctComp__TRIM__TR1_HS_PTR ((void CYFAR *) CapSense_1_CompCH0_ctComp__TRIM__TR1_HS)
    #define CapSense_1_CompCH0_ctComp__TRIM__TR1_HS_REG CY_GET_XTND_REG8(CapSense_1_CompCH0_ctComp__TRIM__TR1_HS_PTR)
#endif /* (CY_PSOC3 || CY_PSOC5LP) */
#define CapSense_1_CompCH0_ctComp__TRIM__TR0_LS_PTR     ((void CYFAR *) ((uint32)CapSense_1_CompCH0_ctComp__TRIM__TR0 + 1u))
#define CapSense_1_CompCH0_ctComp__TRIM__TR0_LS_REG     CY_GET_XTND_REG8(CapSense_1_CompCH0_ctComp__TRIM__TR0_LS_PTR)
#if (CY_PSOC3 || CY_PSOC5LP)
    #define CapSense_1_CompCH0_ctComp__TRIM__TR1_LS_PTR ((void CYFAR *) ((uint32)CapSense_1_CompCH0_ctComp__TRIM__TR1 + 1u))
    #define CapSense_1_CompCH0_ctComp__TRIM__TR1_LS_REG CY_GET_XTND_REG8(CapSense_1_CompCH0_ctComp__TRIM__TR1_LS_PTR)
#endif /* CY_PSOC3 || CY_PSOC5LP */
...
/*      Trim Locations      */
#define CapSense_1_CompCH0_HS_TRIM_TR0        CY_GET_XTND_REG8(CapSense_1_CompCH0_ctComp__TRIM__TR0_HS_PTR)
#if (CY_PSOC3 || CY_PSOC5LP)
    #define CapSense_1_CompCH0_HS_TRIM_TR1    CY_GET_XTND_REG8(CapSense_1_CompCH0_ctComp__TRIM__TR1_HS_PTR)
#endif /* (CY_PSOC3 || CY_PSOC5LP) */
#define CapSense_1_CompCH0_LS_TRIM_TR0        CY_GET_XTND_REG8(CapSense_1_CompCH0_ctComp__TRIM__TR0_LS_PTR)
#if (CY_PSOC3 || CY_PSOC5LP)
    #define CapSense_1_CompCH0_LS_TRIM_TR1    CY_GET_XTND_REG8(CapSense_1_CompCH0_ctComp__TRIM__TR1_LS_PTR)
#endif /* CY_PSOC3 || CY_PSOC5LP */
...
#define CapSense_1_CompCH0_PWR_MODE_MASK      ((uint8)(0x03u << CapSense_1_CompCH0_PWR_MODE_SHIFT))
#define CapSense_1_CompCH0_PWR_MODE_SLOW      ((uint8)(0x00u << CapSense_1_CompCH0_PWR_MODE_SHIFT))
#define CapSense_1_CompCH0_PWR_MODE_FAST      ((uint8)(0x01u << CapSense_1_CompCH0_PWR_MODE_SHIFT))
#define CapSense_1_CompCH0_PWR_MODE_ULOW      ((uint8)(0x02u << CapSense_1_CompCH0_PWR_MODE_SHIFT))

...
#define CapSense_IntClock_SetDivider(clkDivider)         CapSense_IntClock_SetDividerRegister(clkDivider, 1u)
#define CapSense_IntClock_SetDividerValue(clkDivider)    CapSense_IntClock_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define CapSense_IntClock_SetPhaseValue(clkPhase)        CapSense_IntClock_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(CapSense_IntClock__CFG3) */

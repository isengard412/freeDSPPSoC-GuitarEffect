...
void CapSense_SetAllSensorsDriveMode(uint8 mode) 
{
    ...
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e8__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e9__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e10__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e11__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e12__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e13__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e14__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e15__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e16__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e17__LS, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__LinearSlider0_e18__LS, mode);

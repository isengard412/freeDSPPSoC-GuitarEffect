...
// Comp_v2_0(Hysteresis=0, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Comp_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense_1:CompCH0, CY_INSTANCE_SHORT_NAME=CompCH0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP2, INSTANCE_NAME=CapSense_1_CompCH0, )
module Comp_v2_0_1 (
    Vplus,
    CmpOut,
    Vminus,
...
module CapSense_CSD_v3_50_3 (
	...
	cy_psoc3_port_v1_0
		#(.width(22),
		  ...
		  .pin_aliases({"Button0__BTN,But","ton1__BTN,Linear","Slider0_e0__LS,L","inearSlider0_e1_","_LS,LinearSlider","0_e2__LS,LinearS","lider0_e3__LS,Li","nearSlider0_e4__","LS,LinearSlider0","_e5__LS,LinearSl","ider0_e6__LS,Lin","earSlider0_e7__L","S,LinearSlider0_","e8__LS,LinearSli","der0_e9__LS,Line","arSlider0_e10__L","S,LinearSlider0_","e11__LS,LinearSl","ider0_e12__LS,Li","nearSlider0_e13_","_LS,LinearSlider","0_e14__LS,Linear","Slider0_e15__LS,","LinearSlider0_e1","6__LS,LinearSlid","er0_e17__LS,Line","arSlider0_e18__L","S,Button2__BTN"}),
		  .access_mode("HW_ONLY"),
		  .layout_mode("NONCONTIGUOUS"),
		  .port_mode("ANALOG"),

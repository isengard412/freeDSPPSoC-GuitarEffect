...
#define CapSense_CSD_CHECK_SUM      (6464u)
...
{       
    ...
    uint16    signal[CapSense_CSD_TOTAL_SENSOR_COUNT];
    uint8    onMask[CapSense_CSD_TOTAL_SENSOR_MASK_COUNT];
    
    #if (CapSense_CSD_TUNING_METHOD == CapSense_CSD_AUTO_TUNING)
        uint16   fingerThreshold[CapSense_CSD_WIDGET_CSHL_PARAMETERS_COUNT];
        uint16   noiseThreshold[CapSense_CSD_WIDGET_CSHL_PARAMETERS_COUNT];

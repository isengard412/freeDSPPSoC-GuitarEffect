...
void    Mux0_2_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Mux0_2_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Mux0_2__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Mux0_2_SetInterruptMode() function.
     *  @{
     */
        #define Mux0_2_INTR_NONE      (uint16)(0x0000u)
        #define Mux0_2_INTR_RISING    (uint16)(0x0001u)
        #define Mux0_2_INTR_FALLING   (uint16)(0x0002u)
        #define Mux0_2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Mux0_2_INTR_MASK      (0x01u) 
#endif /* (Mux0_2__INTSTAT) */
...
/* SIO registers */
#if defined(Mux0_2__SIO_CFG)
    #define Mux0_2_SIO_HYST_EN        (* (reg8 *) Mux0_2__SIO_HYST_EN)
    #define Mux0_2_SIO_REG_HIFREQ     (* (reg8 *) Mux0_2__SIO_REG_HIFREQ)
    #define Mux0_2_SIO_CFG            (* (reg8 *) Mux0_2__SIO_CFG)
    #define Mux0_2_SIO_DIFF           (* (reg8 *) Mux0_2__SIO_DIFF)
#endif /* (Mux0_2__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Mux0_2_0_INTTYPE_REG 		(* (reg8 *) Mux0_2__0__INTTYPE)
#endif /* (Mux0_2__INTSTAT) */

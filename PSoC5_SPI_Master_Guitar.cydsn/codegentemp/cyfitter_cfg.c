...
#define BS_UDB_0_1_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000120u)

/* UDB_0_1_0_CONFIG Address: CYDEV_UCFG_B1_P4_U1_BASE Size (bytes): 128 */
#define BS_UDB_0_1_0_CONFIG_VAL ((const uint8 CYFAR *)0x480001A0u)
...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 896u, 0x0Eu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_U0_BASE) },	/* TD 13 */
		...
		{ 768u, 0x13u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI4_BASE) },	/* TD 18 */
		...
		{ 8u, 0x19u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_PICU_INTTYPE_PICU15_BASE) },	/* TD 24 */
		...
		{ 128u, 0x23u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI12_BASE) },	/* TD 34 */
		...
		{ 128u, 0x28u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P4_ROUTE_BASE) },	/* TD 39 */
		...
		{ 128u, 0x2Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P4_ROUTE_BASE) },	/* TD 42 */
		{ 128u, 0x2Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P4_ROUTE_BASE + 0x00000080u) },	/* TD 43 */
		{ 128u, 0x2Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI8_BASE + 0x00000080u) },	/* TD 44 */
		{ 128u, 0x2Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE + 0x00000080u) },	/* TD 45 */
		{ 128u, 0x2Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI2_BASE + 0x00000080u) },	/* TD 46 */
		{ 128u, 0x30u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI1_BASE + 0x00000080u) },	/* TD 47 */
		{ 128u, 0x31u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI0_BASE) },	/* TD 48 */
		{ 128u, 0xFEu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI0_BASE + 0x00000080u) },	/* TD 49 */
	};
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_PICU_8_VAL),	/* TD 24 */
		...
		(const void *)(BS_DSISWITCH_0_1_VAL),	/* TD 34 */
		...
		(const void *)(BS_UDBSWITCH_0_1_VAL),	/* TD 39 */
		(const void *)(BS_UDB_1_1_HV_ROUTING_VAL),	/* TD 40 */
		(const void *)(BS_UDB_2_1_HV_ROUTING_VAL),	/* TD 41 */
		(const void *)(BS_UDBSWITCH_0_2_VAL),	/* TD 42 */
		(const void *)(BS_UDB_1_2_HV_ROUTING_VAL),	/* TD 43 */
		(const void *)(BS_DSI3_1_HV_ROUTING_VAL),	/* TD 44 */
		(const void *)(BS_DSI3_2_HV_ROUTING_VAL),	/* TD 45 */
		(const void *)(BS_DSI3_3_HV_ROUTING_VAL),	/* TD 46 */
		(const void *)(BS_DSI3_4_HV_ROUTING_VAL),	/* TD 47 */
		(const void *)(BS_DSISWITCH_1_5_VAL),	/* TD 48 */
		(const void *)(BS_DSI3_5_HV_ROUTING_VAL),	/* TD 49 */
	};
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG0_CFG0), 0x0041u);

...
#define Pins_scl			(Pins__scl__PC)
#define Pins_scl_INTR	((uint16)((uint16)0x0001u << Pins__0__SHIFT))

#define Pins_sda			(Pins__sda__PC)
#define Pins_sda_INTR	((uint16)((uint16)0x0001u << Pins__1__SHIFT))

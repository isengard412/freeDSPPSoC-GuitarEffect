// ======================================================================
// CapSense PSoC5LE.v generated from TopDesign.cysch
// 05/10/2016 at 11:56
...
// Comp_v2_0(Hysteresis=0, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Comp_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense_CSD:CompCH0, CY_INSTANCE_SHORT_NAME=CompCH0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=CapSense_CSD_CompCH0, )
module Comp_v2_0_0 (
    Vplus,
    CmpOut,
    Vminus,
...
module CapSense_CSD_v3_50_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("a10acbf9-64ab-4f78-bb2a-4233acf5b8d3/232398c5-3876-4e07-8f5b-7cd7657055e2"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_port_v1_0
		#(.width(12),
		  .siorefwidth(6),
		  .id("a10acbf9-64ab-4f78-bb2a-4233acf5b8d3/dd9c1af8-be5a-4b9e-b10c-b2d9f11dc9fc"),
		  .pin_aliases({"LinearSlider0_e0","__LS,LinearSlide","r0_e1__LS,Linear","Slider0_e2__LS,L","inearSlider0_e3_","_LS,LinearSlider","0_e4__LS,LinearS","lider0_e5__LS,Li","nearSlider0_e6__","LS,LinearSlider0","_e7__LS,LinearSl","ider0_e8__LS,Lin","earSlider0_e9__L","S,LinearSlider0_","e10__LS,LinearSl","ider0_e11__LS"}),
		  .access_mode("HW_ONLY"),
		  .layout_mode("NONCONTIGUOUS"),
		  .port_mode("ANALOG"),
		  .intr_mode(24'b000000000000000000000000),
		  .drive_mode(36'b100100100100100100100100100100100100),
		  .por_state(0),
		  .enable_shielding(12'b000000000000),
		  .cs_mode(2'b11))
		PortCH0
		 (.oe(tmpOE__PortCH0_net),
		  .y(12'b0),
		  .analog(Net_1410[11:0]),
    ...
    defparam AMuxCH0.muxin_width = 15;
    defparam AMuxCH0.init_mux_sel = 15'h0;
	...
	cy_clock_v1_0
		#(.id("a10acbf9-64ab-4f78-bb2a-4233acf5b8d3/0ad1a1a8-974e-43a0-841b-3af08590011d"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_clock_v1_0
		#(.id("a10acbf9-64ab-4f78-bb2a-4233acf5b8d3/52b807b3-40a8-4a39-b1e7-e18f76c3b871"),
...
module top ;
    ...
    USBFS_v3_0_4 UART_1 (
        .sof(Net_17),
        .vbusdet(1'b0));
    defparam UART_1.epDMAautoOptimization = 0;

...
#define USBFS_1_ENABLE_AUDIO_CLASS             
#define USBFS_1_ENABLE_AUDIO_STREAMING         
...
#define USBFS_1_MAX_INTERFACES_NUMBER  (2u)
...
#define USBFS_1_EP1_ISR_REMOVE     (1u)
...
#define USBFS_1_EP6_ISR_REMOVE     (0u)

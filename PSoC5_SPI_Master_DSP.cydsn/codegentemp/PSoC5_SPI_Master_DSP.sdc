...
# Date: Tue, 12 Jul 2016 20:54:35 GMT
#set_units -time ns
...
create_generated_clock -name {I2S_Clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 5 11} -nominal_period 151.5151515151515 [list [get_pins {ClockBlock/dclk_glb_0}]]
...
create_generated_clock -name {timer_clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 66001 132001} [list [get_pins {ClockBlock/dclk_glb_3}]]

...
#define BS_UDB_1_0_0_CONFIG_VAL ((const uint8 CYFAR *)0x48000028u)

/* UDB_1_0_1_CONFIG Address: CYDEV_UCFG_B1_P2_U1_BASE Size (bytes): 128 */
#define BS_UDB_1_0_1_CONFIG_VAL ((const uint8 CYFAR *)0x480000A8u)
...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 384u, 0x10u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P5_U0_BASE) },	/* TD 15 */
		...
		{ 16u, 0x23u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_BCTL1_MDCLK_EN) },	/* TD 34 */
		...
		{ 128u, 0x2Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P5_ROUTE_BASE + 0x00000080u) },	/* TD 42 */
		{ 128u, 0x2Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_ROUTE_BASE) },	/* TD 43 */
		...
		{ 128u, 0x2Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P3_ROUTE_BASE) },	/* TD 46 */
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_UCFG_BCTL1_VAL),	/* TD 34 */
		...
		(const void *)(BS_UDB_1_0_HV_ROUTING_VAL),	/* TD 42 */
		(const void *)(BS_UDBSWITCH_1_0_VAL),	/* TD 43 */
		(const void *)(BS_UDB_2_0_HV_ROUTING_VAL),	/* TD 44 */
		(const void *)(BS_UDB_1_1_HV_ROUTING_VAL),	/* TD 45 */
		(const void *)(BS_UDBSWITCH_1_1_VAL),	/* TD 46 */
